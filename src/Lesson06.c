...
*	o) CLANG, adossé aux environnements MINGW64 et MINGW32, version 13.0.1 (version gcc 12.0.0) : downloadable on https://winlibs.com/
*	p) CLANG, adossé aux environnements Visual Studio 2022 (+ kits Microsoft), version 13.0.1 : downloadable on https://releases.llvm.org/download.html
*	q) CLANG de la version MSYS2, adossé aux environnements MINGW64 et MINGW32, version 13.0.1 (version gcc 11.2.0) : downloadable on https://repo.msys2.org/distrib/x86_64/msys2-x86_64-20220118.exe
*	r) CLANG de la version CYGWIN, adossé aux environnements MINGW64 et MINGW32, version 8.0.0 (version gcc 11.0.0) : downloadable http://www.cygwin.com/install.html (tool for install and maintained : setup-x86_64.exe)
*
...
* \version         2.0.1.0
* \date            4 février 2022
* \brief           Ouvre une simple fenêtre Windows et dessine un cube avec l'utilisation d'un mapping de texture (NEHE GameDev) stocké dans le répertoire ./data.
