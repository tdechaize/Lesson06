...
#define VER_FILEDESCRIPTION_STR 	"NeHe Lesson06 OpenGL\0"
#define VER_INTERNALNAME_STR 		"Lesson06\0"
...
#define VER_ORIGINALFILENAME_STR 	"Lesson06.exe\0"
// #define VER_PRODUCTNAME_STR 		"Lesson06 OpenGL : Texture mapping on cube in rotation.\0"
